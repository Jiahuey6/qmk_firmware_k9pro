...
#define KC_RCMMDD MT(MOD_RGUI, KC_DOWN) //Tap Right Command Hold Down
#define KC_RALTR MT(MOD_RALT, KC_DOWN) //Tap Right Alt Hold Down
#define KC_RCTLR MT(MOD_RCTL, KC_RIGHT) //Tap right hold rctl
#define KC_RSHIFTU MT(MOD_RSFT, KC_UP) //Tap up hold right shift
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_61_ansi(
        ...
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSHIFTU,
        KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                                 MO(L_FN1),MO(MAC_FN),KC_RCMMDD,KC_RCTLR),
    ...
    [WIN_BASE] = LAYOUT_61_ansi(
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSHIFTU,
        KC_LCTL,  KC_LWIN,  KC_LALT,                                KC_SPC,                                 MO(L_FN1),MO(WIN_FN),KC_RALTR,KC_RCTLR),
    ...
    [WIN_FN] = LAYOUT_61_ansi(
        ...
        _______,  BT_HST1,  BT_HST2,  BT_HST3,  _______,  _______,  _______,  _______,  KC_APP,   KC_SCRL,  KC_INS,   KC_PGUP,  KC_HOME,   KC_END,
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  KC_UP,    KC_PSCR,  _______,  KC_PGDN,            _______,
        _______,            RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  NK_TOGG,  KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_DEL,             _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______),
